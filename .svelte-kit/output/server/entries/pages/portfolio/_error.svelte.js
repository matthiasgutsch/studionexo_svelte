...
const Error = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(MetaTags_1, "MetaTags").$$render(
    ...
    {},
    {}
  )} <div class="error-container"><h1>${escape($page.status)}</h1> <p class="error-message">${escape($page.error?.message || "An error occurred")}</p> <a href="/" class="home-link" data-svelte-h="svelte-1qwlj8y">Go back home</a></div>`;
});
export {
  Error as default
};
